...
/**
 * _memcpy - Func that copies information between void pointers.
 * @newptr: dest ptr.
 * @ptr: source ptr.
...
/**
 * _realloc - Func to reallocates a memory block.
...
/**
 * _reallocdp - Func that reallocates memory block of double ptr.
