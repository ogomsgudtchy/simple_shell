#include "shell.h"
 ...
 /**
 * File name: simpshell-helper1.c
 * Handles Help  for Shell Program.
...
/**
 * help_all - Func to display all possible Built-in Shellby Cmds.
 */
...
/**
 * help_alias - Func to displays info on Shellby built-in cmd 'alias'.
 */
...
/**
 * help_cd - Function that displays info on Shellby built-in command 'cd'.
 */
...
/**
 * help_exit - Function that displays info on Shellby built-in command 'exit'.
 */
...
/**
 * help_help - Function displays info on Shellby built-in command 'help'.
 */
void help_help(void)
{
