...
/**
 * shellby_cd - Function that changes the current directory of the Shellby process.
...
/**
 * shellby_help - Function that displays information about Shellby built-in commands.
 * @args: Array of arguments.
